...
struct netloc_restriction_t;
typedef struct netloc_restriction_t netloc_restriction_t;
...
struct netloc_restriction_t {
    int num_nodes;
    int array_size; /* For growing array nodes */

    /* TODO use union with name for todo with no explicit */
    netloc_node_t **nodes;
};

struct netloc_explicit_t {
    netloc_node_t *nodes; /* hash table of nodes by physical id */
    netloc_node_t *nodes_by_name; /* hash table of nodes by hostname */
...
struct netloc_position_t {
    /* TODO improve when having hierarchical topo */
...
struct netloc_node_t {
    ...
    netloc_position_t *topo_positions; /* Postition in topology in partition */
